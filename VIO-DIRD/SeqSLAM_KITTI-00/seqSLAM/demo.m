...
%% first set the parameters
    ...
    ds.name = 'groundtruth1';
    ds.imagePath = 'E:/dataset/00/image_0';    
    ds.extension='.png';
    ds.suffix='';
    ds.imageSkip = 1;     % use every n-nth image
    ds.imageIndices = 1:ds.imageSkip:4540;    
    ds.savePath = 'results';
    ...
    ds.name = 'groundtruth2';
    ds.imagePath = 'E:/dataset/00/image_1';       
    ds.saveFile = sprintf('%s-%d-%d-%d', ds.name, ds.imageIndices(1), ds.imageSkip, ds.imageIndices(end));
    % ds.crop=[5 1 64 32];
    ds.crop=[];
    ...
    params.dataset(1) = groundtruth1;
    params.dataset(2) = groundtruth2;
...
%% show some results
    ...
    m = results.matches(:,1);
    thresh=0.8;  % you can calculate a precision-recall plot by varying this threshold
